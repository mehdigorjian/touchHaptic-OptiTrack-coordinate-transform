...
void glut_main(int argc, char **argv) {
    ...
    dataObject.Model = new TriMesh("Models/skull1.obj");  // Load a Skull  Model for the Mesh
...
#pragma opm parallel
        {
            ...
            // std::cout << "Transformation Error: " << ee << std::endl;
        }
    }
...
#pragma opm parallel
    ...
    localdataObject->Model->setScaleInPlace(.8);  // 0.3
